...
- XKeen теперь корректно работает со встроенной политикой Кинетика "Без доступа в интернет", часто используемой при настройке родительского контроля. При создании расписания, доступ в интернет прекращается и восстанавливается согласно заданных интервалов времени [#53](https://github.com/jameszeroX/XKeen/pull/53)
- Доработки согласно PR [#32](https://github.com/jameszeroX/XKeen/pull/32), [#57](https://github.com/jameszeroX/XKeen/pull/57), [#58](https://github.com/jameszeroX/XKeen/pull/58), [#59](https://github.com/jameszeroX/XKeen/pull/59)
