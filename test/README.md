...
- При использовании AdGuardHome на роутере, DNS-запросы клиентов политик XKeen теперь идут от их локальных IP-адресов, а не от IP роутера
- Предусмотрен вывод стандартной либо расширенной информации при запуске прокси-клиента (переменная `extend_msg="on/off"`)
