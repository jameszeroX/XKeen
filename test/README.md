...
- При использовании AdGuardHome на роутере, DNS-запросы клиентов политики XKeen теперь идут от их локальных IP-адресов, а не от IP роутера
...
- `ext_exclude`, `ext_exclude6` - наполняются любым сторонним приложением на ваш выбор, например, AdGuard Home или dnsmasq (см. документацию к этим приложениям). Для совместимости со сторонними приложениями скрипт запуска XKeen переименован в S05xkeen
