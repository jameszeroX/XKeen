...
- Добавлена возможность загружать компоненты XKeen через [Self-Hosted прокси](https://github.com/hunshcn/gh-proxy)) при недоступности GitHub (переменая `gh_proxy` в файле `01_info_variable.sh`)
