...
По умолчанию XKeen настроен на работу в [режиме `Hybrid`](XKeen-modes). Если необходимо переключить его в режим чистого `TProxy`, замените следующий файл конфигурации Xray
