...
В прошивке KeeneticOS 5.2 разработчиками введены токены доступа к консольным RCI-запросам (перечень политик, порты, версия прошивки и иные необходимые для XKeen данные). Данный токен можно получить (бесплатно и без смс) в веб интерфейсе роутера в разделе "Пользователи и доступ".
