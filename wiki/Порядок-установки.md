...
По умолчанию XKeen с ядром Xray настроен на работу в режиме `Hybrid`. Если необходимо переключить его в режим чистого `TProxy`, замените следующий файл конфигурации
