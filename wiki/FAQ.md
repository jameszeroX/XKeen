...
1. В веб-интерфейсе Keenetic создайте политику с именем `XKeen` и отметьте в ней нужного провайдера
2. Узнайте метку политик командой `xkeen -pbr codes`
3. В конфиге ядра замените `255` на значение метки:
...
Подробнее — в разделе [«Проксирование через выбранного провайдера»](https://github.com/jameszeroX/XKeen/wiki/Configuration#проксирование-через-выбранного-провайдера).
