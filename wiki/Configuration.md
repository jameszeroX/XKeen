...
При нестабильном соединении один транзиентный сбой может прервать установку или обновление компонентов. В `xkeen.json` можно настроить автоматические повторные попытки загрузки:
