...
Этот режим нужен, если программы из Entware должны ходить в интернет через Xray/Mihomo.
Если нужно только проксировать программы из Entware, без отдельной маршрутизации самого Xray/Mihomo через выбранный WAN, достаточно этого раздела.
