...
**Важно!** В XKeen используется гео-база российских IP, а не база юридической принадлежности AS. Например, подсети Google `173.194.2.0/24` или Akamai `2.17.146.0/24` юридически принадлежат этим компаниям, а географически находятся в России и поэтому содержатся в GeoIPSET XKeen. Если вас это не устраивает, можете исключить "спорные" диапазоны из GeoIPSET с помощью файла `ru_exclude_override.lst`, либо использовать другие источники российских подсетей, указав ссылки на них в файле `01_info_variable.sh`
